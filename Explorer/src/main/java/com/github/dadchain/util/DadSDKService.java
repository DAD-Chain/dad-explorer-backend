...
@Slf4j
@Component
public class DadSDKService {

    private static DadSDKService instance = null;

    @Autowired
    private ParamsConfig paramsConfig;

    public static synchronized DadSDKService getInstance(ParamsConfig param) {
        if (instance == null) {
            instance = new DadSDKService(param);
        }
        return instance;
    }

    public DadSDKService(ParamsConfig param) {
    ...
    public Map getDappBindedNodeInfo(String contractHash, String dappContractHash) {
        ...
        try {
            ...
            if (com.github.dadchain.util.Helper.isNotEmptyOrNull(result)) {
