...
import com.github.dadchain.model.common.OntIdEventEnum;
...
public class Helper {
     ...
     * @return
     */
    public static Boolean isTimeRangeExceed100Days(Long beginTime, Long endTime) {

        if ((endTime - beginTime) > (ConstantParam.REQTIME_MAX_RANGE_100_DAYS)) {
            return true;
        }
        return false;
    }
