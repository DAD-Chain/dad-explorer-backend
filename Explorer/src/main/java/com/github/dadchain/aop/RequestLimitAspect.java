package com.github.dadchain.aop;

import com.github.dadchain.config.ParamsConfig;
import com.github.dadchain.exception.ExplorerException;
...
public class RequestLimitAspect {
    ...
    @Before("execution(public * com.github.dadchain.controller.*.*(..)) && @annotation(limit)")
