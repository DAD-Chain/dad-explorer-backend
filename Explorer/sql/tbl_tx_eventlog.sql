...
(
    ...
    `asset_name`           varchar(64)   DEFAULT '' COMMENT '交易资产名',
    `from_address`         varchar(255)  DEFAULT '' COMMENT '交易fromaddress',
    `to_address`           varchar(255)  DEFAULT '' COMMENT '交易toaddress',
    `amount`               decimal(28, 9) DEFAULT 0 COMMENT '交易数量',
