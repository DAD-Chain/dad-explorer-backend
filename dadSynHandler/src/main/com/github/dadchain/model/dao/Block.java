...
public class Block {
    ...
    @Builder
    public Block(Integer blockHeight, String blockHash, String prevHash, String txsRoot, Integer blockTime, String consensusData, String bookkeepers, Integer txCount, Integer blockSize) {
