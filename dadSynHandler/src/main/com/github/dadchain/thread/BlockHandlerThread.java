...
import com.github.dadchain.service.BlockHandleService;
...
public class BlockHandlerThread extends Thread {
    ...
    /**
     * initialize dad ONT_SDKSERVICE object for synchronizing data
     */
    ...
    private void batchHandleBlockAndInsertDb(int beginHeight, int endHeight) throws Exception {
        ...
        int txCountCur = currentMapper.selectTxCount();
        for (int tHeight = beginHeight; tHeight <= endHeight; tHeight++) {
            ...
            blockManagementService.handleOneBlock(blockJson, txEventLogArray, txCountCur);
            txCountCur += txEventLogArray.size();
        }
    ...
    private void initConstantParam() {
        ...
        ConstantParam.BLOCK_BOOKKEEPER_COUNT = 0;
